<?php
    ...
    if(!$teacher_class && $_SESSION['riive_school_access_level'] == 'Teacher') {
        ...
        $pickup_code           = $error = $success = $error_message = $success_message = $pickup_result = '';
        $no_result             = false;

        if(isset($_POST['submit'])) {
            $pickup_code       = Methods::validate_string($_POST['pickup-code']);

            if(empty($pickup_code)) {
                $error         = true;
                $error_message = 'Please Enter A Code';
            } else {
                $pickup_result = Pickup::read_pickup_by_pickup_code($pickup_code, $conn);
        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-white">View Pickup By Pickup Code</h3>
                </div>
                        ...
                        <div class="card mt-0">
                                ...
                                <div class="row small-form-0">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Code Here" name="pickup-code" value="<?php echo $pickup_code; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th title="Click To Sort By Name Of Pickup Person">Pickup Person</th>
                            ...
                            <div class="card-body <?php if($no_result) { echo 'show'; } ?>">
                                <div class="alert alert-info alert-dismissible fade show text-center font-20">
                                    ...
                                    <strong>0 Results!</strong> No Pickup Found For "<?php echo $pickup_code; ?>"
                                </div>
                            </div>
                            <?php } ?>
                        </div>
                        ...
                        <div class="card mt-0">
                            ...
                            <div class="card-body" id="printable">
                                ...
                                <table class="table">
                                    <tr>
                                        <td>
                                            <h4 class="text-left">Pickup Report For <strong><?php echo $pickup_code; ?></strong></h4>
                                        </td>
                                        <td>
