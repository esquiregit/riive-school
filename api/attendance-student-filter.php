<?php
    ...
    if(!$teacher_class && $_SESSION['riive_school_access_level'] == 'Teacher') {
        ...
        $student_id = $error = $success = $error_message = $success_message = $attendance_result = $student = '';
        $students   = Student::read_teacher_students($teacher_class, $conn);
        $no_result  = false;
    }

    if($_SESSION['riive_school_access_level'] == 'School Admin') {
        $student_id = $error = $success = $error_message = $success_message = $attendance_result = $student = '';
        $students   = Student::read_students($conn);
        $no_result  = false;
    }
    ...
    if(isset($_POST['submit'])) {
        ...
        if(empty($student_id) || $student_id == 'default') {
            ...
            $attendance_result = Attendance::read_attendance_by_student_id($student_id, $conn);
        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-white">View Student's Attendance</h3>
                </div>
                        ...
                        <div class="card mt-0">
                            ...
                            <div class="card-body <?php if($no_result) { echo 'show'; } ?>">
                                <div class="alert alert-info alert-dismissible fade show text-center font-20">
                                    ...
                                    <strong>0 Results!</strong> No Attendance Found For <?php echo Methods::strtocapital(Attendance::read_student_name_by_id($student_id, $conn)); ?>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
                        ...
                        <div class="card mt-0">
                            ...
                            <div class="card-body" id="printable">
                                ...
                                <table class="table">
                                    <tr>
                                        <td>
                                            <h4 class="text-left"><strong><?php echo $student; ?></strong>'s Attendance Report</h4>
                                        </td>
                                        <td>
