<?php
    ...
    if(!$result) {
        Audit_Trail::create_log($_SESSION['riive_school_id'], $_SESSION['riive_school_name'], $_SESSION['riive_school_username'], $_SESSION['riive_school_access_level'], 'Tried To Change View Visitor URL Parameters', $conn);
        die("Please Don't Try To Be Smart....<br /><br /><button class='btn btn-info' onclick='location = \"dashboard.php\";'>Yes Sir!!!</button>");
    }
    ...
    $purpose_of_visit = ucfirst($result->purposeOfVisit);
                ...
                <div class="row display-form" id="printable">
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td>
                                <h4 style="text-align: right !important;">Date: <?php echo '<strong>' . date_format(date_create(Date("Y-m-d H:i:s")), 'd F Y \a\t H:i:s') . '</strong>'; ?></h4>
                            </td>
                        </tr>
                    </table>
