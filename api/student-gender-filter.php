<?php
    ...
    $conn          = $pdo->open();
    $gender       = $error = $success = $error_message = $success_message = $student_result = $school_name = '';
    $no_result     = false;
    //$school_result = Student::read_students_by_gender($gender, $conn);
    ...
    if(isset($_POST['submit'])) {
        ...
        if(empty($gender) || $gender == 'default') {
            ...
            $student_result = Student::read_students_by_gender($gender, $conn);
        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-white">View Students By Gender</h3>
                </div>
                        ...
                        <div class="card border-red mt-0">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="gender" class="form-control">
                                                <option value="default" <?php if(isset($gender) && $gender == 'default') echo 'selected'; ?>>-- Select --</option>
                            ...
                            <div class="card-body <?php if($no_result) { echo 'show'; } ?>">
                                <div class="alert alert-info alert-dismissible fade show text-center font-20">
                                    ...
                                    <strong>0 Results!</strong> No <?php echo Methods::strtocapital($gender, $conn); ?> Students Found
                                </div>
                            </div>
                            <?php } ?>
                        </div>
