...
function SMSSchool({ history }) {
    ...
    React.useEffect(() => {
        ...
        if (user) {
            Axios.post(getBaseURL() + 'get_parents_message_info', { school_id: user.id }, { signal: signal })
                .then(response => {
                    setParents(response.data);
                    // console.log(response.data)
                    // console.log(response.data[index][class_name][0])
                    // console.log(response.data[10]['JHS 1'][0])
                    // console.log(response.data[4][1][0])
                                            ...
                                            <Select
                                                ...
                                                <option aria-label="None" value="" />
                                                {
                                                    parents.map((parent, index) => {
                                                        return (
                                                            <option key={index} value={parent.value}>{parent.label}</option>
                                                        );
                                                    })
                                                }
                                            </Select>
