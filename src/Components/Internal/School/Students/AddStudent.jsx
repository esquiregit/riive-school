...
function AddStudent({ closeModal, closeExpandable }) {
    ...
    const initialValues = {
        dob          : '',
        name         : user.name,
        class        : user && user.class ? user.class : 'JHS 1',
        image        : '',
        gender       : '',
        lastname     : '',
        firstname    : '',
    ...
    const onSubmit     = values => {
        ...
        Axios.post(getBaseURL()+'add_student', formData, { signal: signal })
            .then(response => {
    ...
    return (
        <>
            ...
            <Backdrop className={classes.backdrop} open={backdrop}>
                <CircularProgress color="inherit" /> <span className='ml-15'>Adding Student....</span>
            </Backdrop>
            <Dialog
                    ...
                    {({ isValid, dirty, resetForm, values }) => (
                        <Form encType="multipart/form-data">
                            ...
                            <DialogActions>
                                ...
                                <Tooltip title="Add Student Details">
                                    <Button
                                        type="submit"
